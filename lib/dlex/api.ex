...
defmodule Api.TxnContext do
  ...
  defstruct [:start_ts, :commit_ts, :aborted, :keys, :preds, :hash]
...
defmodule Api.NQuad do
  ...
  defstruct [:subject, :predicate, :object_id, :object_value, :lang, :facets, :namespace]
...
defmodule Api.LoginRequest do
  ...
  defstruct [:userid, :password, :refresh_token, :namespace]
